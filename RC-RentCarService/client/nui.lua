...
Citizen.CreateThread(function()
	while true do
		...
		Citizen.Wait(0)
		local distance2 = GetDistanceBetweenCoords(coords, 413.14874267578,-764.88250732422,29.305688858032, true)
		...
		if distance2 <= 1 then
			if isShopOpen == false then
                if not used1 then
                    ...
                    exports['mythic_notify']:DoCustomHudText('inform', 'Du har allerede lejet 1 bil!')
                    Wait(10000)
                end
			end
